...
import com.example.socialmedia.AddCommentActivity
    ...
    (private val mContext:Context,private  val mPost:List<Post>):RecyclerView.Adapter<PostAdapter.ViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        // Reusable listener for profile clicks
        val goToPublisherProfile = View.OnClickListener {
        ...
        // Set click listeners for publisher-related views
        holder.publisher.setOnClickListener(goToPublisherProfile)
        holder.profileImage.setOnClickListener(goToPublisherProfile)
        holder.username.setOnClickListener(goToPublisherProfile)

        // Post image click listener (like functionality)
        holder.postImage.setOnClickListener {
            val action = if (holder.postImage.tag == "like") {
        ...
        // Open post details when post image is clicked
        holder.postImage.setOnClickListener {
        ...
        // Handle likes and notifications
        holder.likeButton.setOnClickListener {
            val action = if (holder.likeButton.tag.toString() == "like") {
                FirebaseDatabase.getInstance().reference.child("Likes").child(post.getPostId())
                    .child(firebaseUser!!.uid).setValue(true)
        ...
        // Open comments activity when comment button is clicked
        ...
        holder.saveButton.setOnClickListener {
            val action = if (holder.saveButton.tag == "Save") {
